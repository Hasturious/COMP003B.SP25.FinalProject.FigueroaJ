...
namespace COMP003B.SP25.FinalProject.FigueroaJ.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,UserId,RecipeId,Comment")] Review review)
        {
            ...
            ViewData["RecipeId"] = new SelectList(_context.Recipes, "RecipeId", "RecipeId", review.RecipeId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,UserId,RecipeId,Comment")] Review review)
        {
